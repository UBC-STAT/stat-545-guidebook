...
1. Convert a pre-existing ggplot2 graph into an interactive plotly graph.
2. Create an interactive graph using plotly 
...
# create plot using plotly::plot_ly() directly
p <- gapminder %>%
    plot_ly(x = ~gdpPercap,
            y = ~lifeExp,
            color = ~continent,
...
# now we can upload our plots to the website
