...
Follow the instructions on the participation page. 


__Navigating GitHub__

1. Make a new file on your participation repository:
...
4. Your turn: Continue the exercise, and add more URL's:
    - The URL to your participation repo
    - The URL to your user page
5. Together: Commit the changes.
...
## Topic 3: Asking effective questions online
...
3. Your turn: Add a comment to the thread in canvas with the following:
