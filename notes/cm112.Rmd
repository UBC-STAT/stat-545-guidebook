...
- [IBM Watson API](https://www.ibm.com/watson/products-services/)
- [Quandl API](https://www.quandl.com/)

Thanks to [Analytics Vidhya](https://www.analyticsvidhya.com/blog/2016/11/an-introduction-to-apis-application-programming-interfaces-5-apis-a-data-scientist-must-know/) for inspiring this second list.
