...
To do so, just execute `devtools::use_package_doc()`. You'll see a new R script come up with `roxygen2`-style documentation to `NULL`. Document as you'd do functions, and run `devtools::document()` to generate the `.Rd` file. 
