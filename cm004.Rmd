...
Let's use GitHub pages for making your HTML files readble.

1. Set up a basic "GitHub pages" website with your participation repo:
    - Go to "settings" on your repo, and stay on the "Options" tab.
    - Scroll down to "GitHub Pages".
    - Under "Source", click the "None" drop-down button, and select the branch you want to turn into a website.
2. Also under the "GitHub Pages" section, you'll find your website URL. Check it out!
3. Navigate to an HTML file on your repo.
    - Your URL acts as your root directory. You can access files in your repository by adding on the path to the file.
4. Add a link to the HTML file somewhere in your repo, perhaps a README file. Commit your changes and (if working locally) push to GitHub. 
