...
**This lecture is 90% completed.** I need to still restructure things a bit to balance lecturing and code exercises.
...
- Everytime you use a component to change your plot, they will need to be re-created and updated using a wrapper function.
